    ...
    return {
      ...
      examDate: [
          ...
          ]},
        {
          type: 2,
          content: [
          {title: '题目3', choice1: '选项1', choice2: '选项2', choice3: '选项3', choice4: '选项4', answer: [0], ques_no: 3}
          ]},
        {
          type: 3,
          content: [
            {title: '题目4', answer: [0], ques_no: 4}
          ]},
        {
          type: 4,
          content: [
            {title: '1+1=        <div class="input-box">\n' +
                '          <label id="label_" class="input-box__label"></label>\n' +
                '          <input type="text" id="input_" class="input-box__input"/>\n' +
                '        </div>', answer: '', ques_no: 5}
          ]},
        {
          type: 5,
          content: [
            {title: '题目6', answer: '', ques_no: 6}
          ]},

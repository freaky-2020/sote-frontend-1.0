    ...
    <div>
      <el-row :gutter="20">
        ...
        <el-col :span="15" :xs="24">
          <Display ref="display" v-if="flag1 && flag2" :exam_data="examData" :quesNos="quesNos" :details="details" :detailData="detailData" :examId="exam_id" :times="times" :isCheat="isCheat" />
        </el-col>
        <el-col :span="3" :xs="24">

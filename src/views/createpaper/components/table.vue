    ...
    <div class="app-container">
      <div>
        <div style="margin-top: 15px;margin-bottom: 15px">
          <el-input style="width: 300px;margin-right: 30px" placeholder="请输入内容" v-model="input" class="input-with-select">
            <el-select v-model="select" style="width: 80px" slot="prepend" placeholder="请选择">
          ...
          <el-input style="width: 235px;margin-right: 30px" placeholder="请输入学校" v-model="school" class="input-with-select">
          </el-input>

          <el-input style="width: 235px" placeholder="请输入专业" v-model="major" class="input-with-select">
          </el-input>
        </div>
        <el-table
  ...
  computed: {
    sTable(){
      return this.tableData.filter((u) => {
        return u.userUniv.indexOf(this.school) !== -1
      })
    },
    mTable(){
      return this.sTable.filter((u) => {
        return u.userUnit.indexOf(this.major) !== -1
      })
    },
    newTable() {
      return this.mTable.filter((u) => {
        return u.roleId === 3
      })
    },
    nnewTable: {
